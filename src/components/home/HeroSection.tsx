...
const HeroSection = () => {
    ...
    return (
        <section className="relative min-h-screen flex items-center justify-center -mt-10pt-16 overflow-hidden">
            ...
            <div className="container mx-auto px-4 flex flex-col md:flex-row items-center justify-between gap-12 z-10">
                ...
                <div className="flex-1 max-w-md">
                    <FadeIn duration={200}>
                        <div className="overflow-hidden w-full max-w-[400px] mx-auto rounded-3xl">
                            <div
                                ...
                                {heroSlideshowImages.map((slide) => (
                                    ...
                                    >
                                        <img
                                            src={slide.src}
                                            alt={slide.alt}
                                            className="w-[300px] h-[200px] md:w-[500px] md:h-[400px] object-cover rounded-2xl"
                                        />
                                    </div>
                                ))}
                            </div>
                    ...
                    <div className="absolute bottom-20 md:bottom-10 left-1/2 animate-bounce">
                        <a
                            href="#how-it-works"
