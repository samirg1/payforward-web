  ...
  return (
    <div className="space-y-8">
      <div>
        ...
        <p className="text-muted-foreground mb-4">
          This Cookie Policy explains how PayForward uses cookies and similar technologies to recognize you when you visit our website and mobile application.
        </p>
      </div>
      ...
      <div>
        ...
        <p className="text-muted-foreground mb-4">
          Please note that blocking cookies may affect the functionality of our website and services.
        </p>
      </div>

      <div>
        <h3 className="text-xl font-bold mb-3">4. Changes to this Cookie Policy</h3>
        <p className="text-muted-foreground mb-4">
